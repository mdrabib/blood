<?php
    ...
    $userdata=$this->session->get_userdata()['pt'];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="<?= base_url('') ?>" class="b-brand">
                    ...
                    <span class="b-title">Blood Donor Club</span>
                </a>
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                        <a href="<?= base_url('donor') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Donor</span></a>
                    </li>
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                        <a href="<?= base_url('patient') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Patient</span></a>
                    </li>
                    </li>
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                        <a href="<?= base_url('stock') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Blood Stock</span></a>
                    </li>
                    <li class="nav-item pcoded-menu-caption">
