					...
					<div class="card-body">
						<?= form_open_multipart() ?>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" value="<?= set_value('name', $userdata->name) ?>" name="name" id="name">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<img src="<?= 
									base_url('upload/profile/demo.jpg') 
									?>" id="photo_p" class="my-1" width="100px" alt="">
								</div>
							</div>
							<div class="form-group row">
